...
class YourApplication : Application() {
    ...
    private fun initLynxService() {
        ...
        LynxServiceCenter.inst().registerService(LynxDevToolService::class.java, LynxDevToolService())

        // register Bestra Native Module
        LynxEnv.inst().registerModule("BestraNative", BestraNativeModule::class.java)
    }
